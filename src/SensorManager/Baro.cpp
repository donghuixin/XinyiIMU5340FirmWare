...
const SampleRateSetting<18> Baro::sample_rates = {
    ...
    {0.001, 0.003, 0.006, 0.01, 0.02, 0.05, 0.1, 0.2, 0.39, 0.78, 1.5, 3.1,
     6.25, 12.5, 25.0, 50.0, 100.0, 200.0}, // sample_rates

    {0.001, 0.003, 0.006, 0.01, 0.02, 0.05, 0.1, 0.2, 0.39, 0.78, 1.5, 3.1,
     6.25, 12.5, 25.0, 50.0, 100.0, 200.0} // true_sample_rates
};
