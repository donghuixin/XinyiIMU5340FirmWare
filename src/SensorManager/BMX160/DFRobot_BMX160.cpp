 ...
 * @brief define DFRobot_BMI160 class infrastructure, the implementation of basic methods
...
void DFRobot_BMI160::getAllData(sBmx160SensorData_t *magn, sBmx160SensorData_t *gyro, sBmx160SensorData_t *accel){
